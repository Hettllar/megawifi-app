...
Route::post('/iptv/channels', [BalanceCheckController::class, 'getChannels'])->name('iptv.channels')->withoutMiddleware([VerifyCsrfToken::class]);
...
// Auto-login from mobile app via API token
Route::get('/app-login', function (\Illuminate\Http\Request $request) {
...
Route::middleware('auth')->group(function () {
    ...
    // ZeroTier Routes
    Route::post('/api/mobile/routers/{routerId}/zerotier/setup', [\App\Http\Controllers\Api\MobileApiController::class, 'setupRouterZerotier']);
    Route::get('/api/mobile/routers/{routerId}/zerotier/status', [\App\Http\Controllers\Api\MobileApiController::class, 'routerZerotierStatus']);
    Route::post('/api/mobile/routers/{routerId}/zerotier/disable', [\App\Http\Controllers\Api\MobileApiController::class, 'disableRouterZerotier']);
    Route::post('/api/mobile/routers/{routerId}/zerotier/heartbeat', [\App\Http\Controllers\Api\MobileApiController::class, 'updateZerotierHeartbeat']);
    ...
    Route::post('/admin/backups/{router}/create', [BackupController::class, 'create'])->name('admin.backups.create');
    Route::get('/admin/backups/{router}/download/{filename}', [BackupController::class, 'download'])->name('admin.backups.download');
    Route::delete('/admin/backups/{router}/delete/{filename}', [BackupController::class, 'delete'])->name('admin.backups.delete');
    Route::post('/admin/backups/{router}/restore/{filename}', [BackupController::class, 'restore'])->name('admin.backups.restore');
    Route::post('/admin/backups/backup-all', [BackupController::class, 'backupAll'])->name('admin.backups.backupAll');
});
