    ...
    <form action="{{ route('routers.store') }}" method="POST" class="space-y-6">
        ...
        <div class="bg-white rounded-xl shadow p-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div>
                    ...
                    <input type="text" name="ip_address" value="{{ old('ip_address', $nextWgIP ?? '10.10.0.10') }}" readonly
        ...
        <div class="bg-gradient-to-l from-purple-600 to-indigo-700 rounded-xl shadow p-6 text-white">
            ...
            <div class="bg-white/10 rounded-lg p-4 mb-4">
                ...
                <p class="text-3xl font-bold font-mono">{{ $nextWgIP ?? '10.10.0.10' }}</p>
            </div>
            
            <input type="hidden" name="wg_enabled" value="1">
            <input type="hidden" name="wg_client_ip" value="{{ $nextWgIP ?? '10.10.0.10' }}">
            ...
            <div class="grid grid-cols-3 gap-4 text-sm">
                ...
                <div class="bg-white/10 rounded-lg p-3">
                    ...
                    <p class="font-mono">10.10.0.0/24</p>
                </div>
                <div class="bg-white/10 rounded-lg p-3">
