...
class Router extends Model
{
    ...
    {
        // Priority: ZeroTier > WireGuard > Direct IP
        if ($this->zt_enabled && $this->zt_ip) {
            return $this->zt_ip;
        }
    ...
    // ZeroTier helpers
    public function getZtConnectedAttribute(): bool
    {
        if (!$this->zt_enabled || !$this->zt_last_seen) {
            return false;
        }
        return $this->zt_last_seen->diffInMinutes(now()) < 5;
    }
